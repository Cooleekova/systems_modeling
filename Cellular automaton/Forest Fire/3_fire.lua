--[[
A burning cell becomes burned after two time steps, instead of only one.
--]]
        ...
        model.cell = Cell{
            ...
            execute = function(cell)
                if cell.state == "burning" and cell.past.state ~= "burning"  then
                    cell.state = "burning"
                elseif cell.state == "burning" and cell.past.state == "burning" then
                    cell.state = "burned"
...
chart1:save("result_3_1.png")
chart2:save("result_3_2.png")


file = File("output_3.csv")
file:write(m.output, ";")

file = File("summary_3.csv")
